          ...
          ({ title, website, techStack, shortDescription, github }) => (
            ...
            >
              ...
              <div className="card-body rounded-bottom-4 bg-white w-100 d-flex flex-column align-items-center">
                ...
                <div className="my-3 d-flex justify-content-center w-100 text-center text-secondary">
                  {website && (
                    <>
                      <a
                        className="w-auto link-underline-secondary link-underline-opacity-0 link-underline-opacity-100-hover"
                        href={website}
                        target="_blank"
                      >
                        Website
